namespace NLib.ComponentModel.DataAnnotations.Tests
{
    ...
    [TestFixture]
    public class GreaterThanOrEqualsToAttributeTest
    {
        [Test]
        public void PropertyGreaterThanValue()
        {
            var model = new ModelProperty { P1 = "3", P2 = "9" };
        ...
        {
            var model = new ModelProperty { P1 = "10", P2 = "10" };
        ...
        public void PropertyAreNotEqualValue()
        {
            ...
            Assert.AreEqual("'P2' must be greater than or equals to 'P1'.", vr[0].ErrorMessage);
        }
        ...
        {
            [GreaterThanOrEqualsTo("P2", MustBeSameType = true)]
            public string P1 { get; set; }
            public string P2 { get; set; }
        }
