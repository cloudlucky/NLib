// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReflectionHelperExtension.cs" company=".">
...
namespace NLib.Reflection.Extensions
{
    ...
    public static class ReflectionHelperExtension
    {
        ...
        public static FieldHelper<T, object> Field<T>(this ReflectionHelper<T> helper, string name)
        {
            ...
            Check.Requires<MissingFieldException>(fieldInfo != null, new { className = helper.Type.Name, fieldName = name });
        ...
        public static FieldHelper<T, TKey> Field<T, TKey>(this ReflectionHelper<T> helper, Expression<Func<T, TKey>> keySelector)
        {
            ...
            Check.Requires<FieldAccessException>(fieldInfo != null, string.Format(ReflectionResource.IsNotFieldInfo, "keySelector"));
        ...
        public static PropertyHelper<T, object> Property<T>(this ReflectionHelper<T> helper, string name)
        {
            ...
            Check.Requires<MissingMemberException>(propertyInfo != null, new { className = helper.Type.Name, memberName = name });
        ...
        public static PropertyHelper<T, TKey> Property<T, TKey>(this ReflectionHelper<T> helper, Expression<Func<T, TKey>> keySelector)
        {
            ...
            Check.Requires<MemberAccessException>(propertyInfo != null, string.Format(ReflectionResource.IsNotPropertyInfo, "keySelector"));
        ...
        {
            Check.ArgumentNullException(value, "value");
