namespace NLib.Collections.Generic.Extensions
{
    ...
    public static class ListExtensions
    {
        ...
        {
            Check.Current.ArgumentNullException(list, "list")
                         .Requires<IndexOutOfRangeException>(index1 >= 0 && index1 < list.Count, IListExtensionResource.SwapValues_IndexOutOfRangeException_Index1)
                         .Requires<IndexOutOfRangeException>(index2 >= 0 && index2 < list.Count, IListExtensionResource.SwapValues_IndexOutOfRangeException_Index2);
